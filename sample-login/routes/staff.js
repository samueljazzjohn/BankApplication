Lyte.Router.registerRoute("staff", {

	renderTemplate: function () {
		return { outlet: "#outlet", component: "staff-home" }
	},
	...
	model: function (paramsObject) {
		...
		// console.log(Lyte.Router.getRouteInstance('staff'))
		console.log('_______')
		
		data={user_id:localStorage.getItem("user_id")}
		// store.findAll("customer").then(function(res){
		...
		return store.findRecord("staff","1",data).then(function(res){
